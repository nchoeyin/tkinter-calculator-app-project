...
def button_equal():
  second_number = e.get()
  e.delete(0,END)
  if sym=="multiplication":
    e.insert(0,f_num*int(second_number))
  elif sym=="division":
    e.insert(0,f_num/int(second_number))
  elif sym=="subtraction":
    e.insert(0,f_num-int(second_number))
  elif sym=="addition":
    e.insert(0,f_num+int(second_number))
...
button_clr = Button(root,text="Clear", padx=77, pady=20, command= button_clear)
...
button_subtract=Button(root,text="-",pady=20, padx=40,command=button_subtract)

#upload or display the buttons
